...
//    }
//
//    @Quando("preencher {string}, data inicial e data final")
//    public void preencher_data_inicial_e_data_final(String string) {
//        componente.setFields(string);
//    }
//
...
//    public void que_o_usuário_pesquisou_a_sala_que_deseja_alterar() {
//        componente.findOcupacao("1994");
//    }
//
//    @Dado("clicou em um agendamento")
//    public void clicou_em_um_agendamento() {
//        componente.agendamentoClick();
//    }
//
...
//    }
//
//    @Dado("alterou a informação para {string}")
//    public void alterou_a_informação_para(String string) {
//        componente.changeInfo(string);
//    }
//
...
//    public void o_usuário_pesquisar_a_sala_alterada() {
//        componente.findOcupacao("1994");
//    }
//
//    @Então("a informação sera {string}")
//    public void a_informação_sera(String string) {
//        componente.validarInfo(string);
//    }
//
...
//        componente.validarOcupacaoFalse();
//        componente.quitWebDriver();
//    }
}
